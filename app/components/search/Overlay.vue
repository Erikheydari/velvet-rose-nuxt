...
// Use the slide panel composable
const {
  panelStyle,
  panelTouchHandlers,
  ...
  <Transition 
    ...
    <div 
      ...
      class="
        ...
        p-4 md:px-8 pt-8
        md:h-auto md:max-h-[60vh] 
        overflow-hidden
        touch-none
      " 
      @click="stopPropagation"
      v-bind="panelTouchHandlers"
      dir="rtl">
      ...
      <!-- Search Input -->
      <div class="flex items-center gap-2 mb-4 mt-4 md:mt-0">
        <div class="flex-1 relative">
          <Input 
            ...
            class="w-full h-12 px-4 body-2 text-base md:text-sm" 
            type="text" 
            autocomplete="off" 
            spellcheck="false" />
        ...
        <TheButton 
          variant="default" 
          size="icon-lg" 
          class="h-12 w-12 shrink-0 touch-manipulation"
          @click="handleSubmit" 
        ...
        <!-- Close button -->
        <TheButton 
          variant="tonalDestructive" 
          size="icon-lg" 
          class="md:flex hidden shrink touch-manipulation"
          @click="handleClose" 
          aria-label="بستن">
          <X class="size-5" />
        </TheButton>
