<template>
  ...
  <SectionsHomeCategory :category="categoriesStore.getCategoryBySlug('perfume-cologne') as Category">
    <SectionsHeading title="جایی که عطر، شخصیت می‌سازد" description="لوکس‌ترین عطرها، برای خاص‌ترین لحظه‌ها" />
